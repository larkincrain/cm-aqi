defmodule CmAqiWeb.Layouts do
  ...
  def app(assigns) do
    ...
    <header class="navbar bg-base-200 px-4 sm:px-6 lg:px-8 shadow-sm">
      <div class="flex-1">
        <a href="/" class="flex items-center gap-2 text-xl font-bold">
          <img src={~p"/images/navbar-icon.png"} alt="Chiang Mai Air" class="h-5 w-5 rounded" />
    ...
    <footer class="footer footer-center p-4 bg-base-200 text-base-content mt-8">
      <div>
        <p>CM AQI — Chiang Mai Air Quality Monitor. Open source on GitHub.</p>
      </div>
    </footer>
